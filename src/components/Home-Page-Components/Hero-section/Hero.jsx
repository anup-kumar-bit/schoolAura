...
export default function Hero() {
    return (
        <div className="bg-[#ff5202] h-[737px] xl:h-[555px] relative border-2 border-black flex items-center justify-center overflow-hidden">
            ...
            <div className="container max-w-[1620px] border-3 border-red-300 z-10 flex justify-around " data-aos="zoom-in-up">
                <div className="border-2 border-black flex flex-col gap-5 w-[1134px]">
                    <div className="">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2  xl:grid-cols-4 xl:grid-rows-1">
                        <Card className={'max-w-[250px] w-[250px] min-w-[168px] h-[212px] gap-0 py-[18px] rounded-md  shadow-[0_0_15px_rgba(0,0,0,0.8)]'}>
                            <CardHeader>
